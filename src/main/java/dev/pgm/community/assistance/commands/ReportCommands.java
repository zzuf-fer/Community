...
public class ReportCommands extends CommunityCommand {
  ...
  public ReportCommands(FeatureManager features) {
  ...
  private static final String REPORTS_CMD = "reports|reporthistory|reps";

  @CommandMethod(REPORTS_CMD + " [page]")
  ...
  @CommandMethod(REPORTS_CMD + " player <player> [page]")
